...
验证这 10 个完美分离特征是「提示词驱动」还是「主题驱动」：

| Feature ID | 类型 | 激活率 | 平均激活值 | 语义推断 |
|------------|------|--------|-----------|----------|
| **Novice 独占** ||||
| 34942 | 新手 | 100% (50/50) | 1.63 | "教学模式"主开关 |
| 59519 | 新手 | 100% (50/50) | 1.60 | "简化解释"信号 |
| 17913 | 新手 | 100% (50/50) | 0.49 | "新手定向"调制器 |
| 55982 | 新手 | 100% (50/50) | 0.18 | 辅助教学信号 |
| **Expert 独占** ||||
| 46703 | 专家 | 100% (50/50) | 0.53 | "专业模式"主开关 |
| 21604 | 专家 | 100% (50/50) | 0.41 | "深度分析"信号 |
| 5936 | 专家 | 100% (50/50) | 0.33 | "底层原理"调制器 |
| 51630 | 专家 | 100% (50/50) | 0.23 | 辅助专业信号 |
| 35870 | 专家 | 100% (50/50) | 0.17 | 辅助专业信号 |
| 53369 | 专家 | 100% (50/50) | 0.13 | 辅助专业信号 |

**关键发现：所有 10 个特征在各自条件下都是 100% 激活。**

无论问的是 Raft 共识、Docker 容器还是 SQL 注入——只要用 Novice 提示词，那 4 个特征就**必定**激活；只要用 Expert 提示词，那 6 个特征就**必定**激活。

**结论：这些是纯粹的「提示词驱动」特征，构成模型切换「教学模式」和「专业模式」的神经开关。**
...
| `step4b_feature_context.py` | 激活样本分析（成功） |
...
| `feature_context.json` | 特征语义分析（100% 激活率验证） |
| `paper_sae.md` | 英文论文 |
...
| Day 2 | Feature 语义 | v2 | 100% 激活率：我们找到了大模型的「模式开关」 | ✅ |
