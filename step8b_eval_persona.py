"""
Step 8b: 用 DeepSeek API 评价 9 种人格条件的回答质量

输入：answers_persona.json（step7b 生成）
输出：eval_results_persona.json
...
OUTPUT_FILE = "eval_results_persona.json"
...
# --- 条件列表 ---
CONDITIONS = ["standard", "teacher", "socratic", "child", "interviewer", "debugger", "critic", "eli5", "assistant"]
