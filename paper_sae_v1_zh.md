...
**讨论论文 v1** — 基于 [Zhao (2026)](https://zenodo.org/records/18410085) 的稀疏自编码器分析扩展
...
1. **新手提示比专家提示激活多 17% 的 SAE 特征**
2. **369 个特征是新手独占的**，专家独占 208 个
3. **10 个特征在两种条件之间实现完美分离**
4. **激活强度不变**——效果在于哪些特征，而非激活强度

对提示工程的启示：**"向新手解释"可能比"作为专家解释"更强大**——因为教学迫使模型激活更多的知识。
